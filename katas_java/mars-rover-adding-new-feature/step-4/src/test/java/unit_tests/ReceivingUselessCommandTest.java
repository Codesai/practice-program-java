...
public class ReceivingUselessCommandTest {
    ...
    public void does_nothing_when_receiving_empty_commands_sequence() {
        MarsRover marsRover = aMarsRoverAnywherePointingToAnyDirection().understandingNasaCommands().build();

        marsRover.receive("");

        assertThat(marsRover, is(aMarsRoverAnywherePointingToAnyDirection().understandingNasaCommands().build()));
    }
